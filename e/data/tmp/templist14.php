               ...
               <ul class="ywfw gongsi">
                    <li>
                        <div class="about-right-t">
                            ...
                            <div class="navIndex"><div class="navIndex"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a>公司简介</a></div></div>
                        </div>
...
?>
                    ...
                    <li>
                        <div class="about-right-t">
                            ...
                            <div class="navIndex"><div class="navIndex"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a>发展历程</a></div></div>
                        </div>
                        <div class="about-right-b">
                            <?php
$bqno=0;
...
?>
                    ...
                    <li>
                        <div class="about-right-t">
                            ...
                            <div class="navIndex"><div class="navIndex"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a>公司理念</a></div></div>
                        </div>
                        <div class="about-right-b">
                            <?php
$bqno=0;
...
?>
                    ...
                    <li>
                        <div class="about-right-t">
                            ...
                            <div class="navIndex"><div class="navIndex"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a>组织架构</a></div></div>
                        </div>
                        <div class="about-right-b">
                            <?php
$bqno=0;
...
?>
                    ...
                    <li>
                        <div class="about-right-t">
                            ...
                            <div class="navIndex"><div class="navIndex"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a>公司资质</a></div></div>
                        </div>
                        <div class="about-right-b">
                            <?php
$bqno=0;
