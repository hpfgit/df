        ...
        <div class="about-left">
            <div class="about-left-top">
                <div class="about-left-t clearfix">
                    <p>A</p>
                    <div class="guan clearfix"><p>机构名录</p><p>bout Ding Feng</p></div>
                </div>
                <ul class="about-left-list">
                    <li><a href="/zonggongsi/">总公司</a></li>
                    <li><a href="/zigongsi/">子公司</a></li>
                    <li><a href="/fengongsi/">分公司</a></li>
                </ul>
            </div>
        </div>
