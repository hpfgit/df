        ...
        <div class="about-left">
            <div class="about-left-top">
                <div class="about-left-t clearfix">
                    <p>C</p>
                    <div class="guan clearfix"><p>经典案例</p><p>lassic case</p></div>
                </div>
                <ul class="about-left-list">
<? @sys_ShowClassByTemp(11,1,0,0);?>
                </ul>
            </div>
...
?>
        ...
        <div class="about-right">
            ...
            <div class="about-right-b">
                <ul class="about-right-b-list">
[!--empirenews.listtemp--]
                          <!--list.var1-->
                          [!--empirenews.listtemp--]
                </ul>
                <div class="showpage">
                    <div class="page-info"><span class="current-page">1</span>页/共<span class="total-page">6</span>页</div>
                    <ul class="showpage-list">
[!--show.listpage--]
                    </ul>
                </div>
            </div>
