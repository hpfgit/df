            ...
            <div class="about-left">
                ...
                <div class="about-left-bottom">
                    ...
                    <div class="address">
                        <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(6,10,0,0);
if($ecms_bq_sql){
...
<div class="login-right">
        <div class="login-t">
            <div class="login-p">我要登录</div>
            <div class="triangle-down login-p-s"></div>
        </div>
        <form autocomplete="off" action="/e/member/doaction.php" method="post" class="form">
...
<input type="hidden" name="ecmsfrom" value="9">
            ...
            <p class="form-p-s">
                ...
                <img src="[!--news.url--]skin/default/images/jp.png" alt="" class="jp">
        ...
        <div class="register">
            <a href="">忘记密码 >></a><span>还没有账号?</span><a href="http://www.hbdfzx.com/e/member/register/index.php?tobind=0&groupid=1&button=%E4%B8%8B%E4%B8%80%E6%AD%A5">立即注册>></a>
            <div class="line"></div>
