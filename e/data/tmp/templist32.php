...
?>
            ...
            <div class="about-right">
                        <div class="about-right-t">
                            <span class="yw-title">企业文化</span>
                            <div class="navIndex">
                                <div class="navIndex"><a href="/">首页</a>&nbsp;&gt;&nbsp;<a>企业文化</a></div>
                            </div>
                        </div>
                        <div class="about-right-b qywh-right-b">
[!--empirenews.listtemp--] 
<!--list.var1--> 
[!--empirenews.listtemp--]

<div class="showpage-list">[!--show.listpage--]</div>
                        </div>
                </ul>
            </div>
        </div>
