...
<div class="banner">
    <ul class="banner-list clearfix">
        <li><a href=""><img src="[!--news.url--]skin/default/images/about.jpg" alt=""></a></li>
...
?>
        ...
        <div class="about-right">
            <div class="about-right-t">
                在线留言
                <div class="navIndex">[!--newsnav--]</div>
            </div>
...
<div>
<p>请输入姓名：<input name='title' type='text' class="sers" placeholder = '请输入姓名'>
</p>
<p>您的手机号：<input name='mycall' type='text'  class="sers" placeholder = '请输入您的手机号'></p>
<p><span class="neirong">请输入内容：</span><textarea name='saytext' style="padding-left:15px;"  class="sers" placeholder="请输入内容"></textarea></p>
<p><input type='submit' name='submit' value='提交留言' class="cx"></p>
</div>
</form>
            </div>
        </div>
