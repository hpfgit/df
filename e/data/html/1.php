...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>导航企业文化</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("qywhnav",$ecmsfirstpost==1?"":stripSlashes($r[qywhnav]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>导航业务范围</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("ywjsnav",$ecmsfirstpost==1?"":stripSlashes($r[ywjsnav]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>发展历程</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("fzlc",$ecmsfirstpost==1?"":stripSlashes($r[fzlc]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>公司理念</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("gsly",$ecmsfirstpost==1?"":stripSlashes($r[gsly]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>组织架构</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("zzjg",$ecmsfirstpost==1?"":stripSlashes($r[zzjg]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>公司简介</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("gsjj",$ecmsfirstpost==1?"":stripSlashes($r[gsjj]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>公司资质</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("gszz",$ecmsfirstpost==1?"":stripSlashes($r[gszz]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>企业文化</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("qywh",$ecmsfirstpost==1?"":stripSlashes($r[qywh]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>导航关于鼎峰</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>工作流程图</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("gzlct",$ecmsfirstpost==1?"":stripSlashes($r[gzlct]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>业务领域</td><td bgcolor='ffffff'>
<input name="ywly" type="text" id="ywly" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[ywly]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>业务领域内容</td><td bgcolor='ffffff'><?=ECMS_ShowEditorVar("ywlyc",$ecmsfirstpost==1?"":stripSlashes($r[ywlyc]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>行业业绩</td><td bgcolor='ffffff'>
<input name="hyyj" type="text" id="hyyj" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[hyyj]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>行业业绩内容</td><td bgcolor='ffffff'><?=ECMS_ShowEditorVar("hyyjc",$ecmsfirstpost==1?"":stripSlashes($r[hyyjc]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>子公司</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("zgs",$ecmsfirstpost==1?"":stripSlashes($r[zgs]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>总公司</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("zonggs",$ecmsfirstpost==1?"":stripSlashes($r[zonggs]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>分公司</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("fgs",$ecmsfirstpost==1?"":stripSlashes($r[fgs]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>职位</td><td bgcolor='ffffff'>
<input name="zw" type="text" id="zw" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[zw]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>部门</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>人数</td><td bgcolor='ffffff'>
<input name="rs" type="text" id="rs" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[rs]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>联系我们</td><td bgcolor='ffffff'>
<?=ECMS_ShowEditorVar("lxwm",$ecmsfirstpost==1?"":stripSlashes($r[lxwm]),"Basic","","300","100%")?>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>案例类型</td><td bgcolor='ffffff'>
