...
E_D("DROP TABLE IF EXISTS `df_enewspublic_update`;");
E_C("CREATE TABLE `df_enewspublic_update` (
...
E_D("replace into `df_enewspublic_update` values('1','1355124469','1355124476','135','0','|1,135|','','1504053474','1504053474','24','19','0','0');");
