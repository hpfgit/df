...
E_D("DROP TABLE IF EXISTS `df_enewsmembergroup`;");
E_C("CREATE TABLE `df_enewsmembergroup` (
...
E_D("replace into `df_enewsmembergroup` values('1','普通会员','1','0','120','0','255','50','1','1','0','1','0','0','0');");
E_D("replace into `df_enewsmembergroup` values('2','VIP会员','2','0','200','0','255','120','0','1','0','1','0','0','0');");
E_D("replace into `df_enewsmembergroup` values('3','企业会员','1','0','120','0','255','50','1','2','0','2','0','0','0');");
E_D("replace into `df_enewsmembergroup` values('4','企业VIP会员','2','0','200','0','255','120','0','2','0','2','0','0','0');");
