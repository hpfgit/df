...
E_D("DROP TABLE IF EXISTS `df_enewsclass_stats_set`;");
E_C("CREATE TABLE `df_enewsclass_stats_set` (
...
E_D("replace into `df_enewsclass_stats_set` values('1','3600','0','20130717');");
